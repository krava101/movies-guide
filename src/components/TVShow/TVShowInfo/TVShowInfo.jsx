...
export default function TVShowInfo() {
  ...
  return (
    ...
    <div className={css.showInfo}> 
      ...
      {show.tagline && <p>Tagline: <span>{show.tagline}</span></p>}
      <p>Release: <span>{show.first_air_date}</span></p>
      <MovieInfoList array={show.production_countries}>Countries: </MovieInfoList>
