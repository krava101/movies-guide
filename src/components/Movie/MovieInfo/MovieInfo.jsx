...
export default function MovieInfo() {
  ...
  return (
    <div className={scss.movieInfo}>
      ...
      <MovieInfoList array={movie.production_countries}>
        Countries:{' '}
      </MovieInfoList>
      <MovieInfoList array={movie.spoken_languages}>
        Spoken languages:{' '}
      </MovieInfoList>
      <p>
        Budget: <span>{movie.budget ? '$' + movie.budget : 'No data'}</span>
      </p>
      <p>
        Revenue: <span>{movie.revenue ? '$' + movie.revenue : 'No data'}</span>
      </p>
      <p>
